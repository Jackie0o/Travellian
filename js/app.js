(() => {
    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker]")) {
            const pickerStart = datepicker_min("[data-datepicker-start]", {
                id: 1,
            ...
            const pickerEnd = datepicker_min("[data-datepicker-end]", {
                id: 1,
                customDays: [ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" ],
                customMonths: [ "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ],
                overlayButton: "Apply",
        ...
        function initSliders() {
            ...
            if (document.querySelector(".pop-destinations__slider")) new swiper_core_Swiper(".pop-destinations__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".pop-destinations__swiper-button-prev",
                    nextEl: ".pop-destinations__swiper-button-next"
                },
                breakpoints: {
                    480: {
                        slidesPerView: 1.7,
            ...
            if (document.querySelector(".trip__slider")) new swiper_core_Swiper(".trip__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.1,
            ...
            if (document.querySelector(".experiences__slider")) new swiper_core_Swiper(".experiences__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.1,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".experiences__swiper-button-prev",
                    nextEl: ".experiences__swiper-button-next"
                },
                breakpoints: {
                    480: {
                        slidesPerView: 1.2,
...
***************************************************************************** */
        ...
        for (let i = 0; i < count; i++) columns[i].classList.add(`footer__column--${i + 1}`);
        window["FLS"] = true;
        isWebp();
        addTouchClass();
        addLoadedClass();
